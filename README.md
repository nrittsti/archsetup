...
# install base system
pacstrap /mnt btrfs-progs base base-devel git linux linux-lts linux-firmware nano micro bash-completion intel-ucode amd-ucode networkmanager man-db man-pages texinfo fish ansible
